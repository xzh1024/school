...
import Profit from '../components/my/profit/profit.vue' //我的收益
import ProfitRule from '../components/my/profit/profitRule.vue' //收益说明
import Settlement from '../components/my/profit/settlement.vue' //收益结算
import ExtractRecord from '../components/my/profit/extractRecord.vue' //提现记录
import RechargeCalculator from '../components/my/rechargeCalculator/rechargeCalculator.vue' //佣金计算器
import Ranklist from '../components/my/ranklist/ranklist.vue' //佣金排行榜
import Faq from '../components/my/faq/faq.vue' //佣金-常见问题
import OfficialAnnounce from '../components/my/officialAnnounce/officialAnnounce.vue' //官方公告
import Opinion from '../components/my/opinion/opinion.vue' //意见反馈
import FansList from '../components/my/fansList/fansList.vue' //玩粉
import StartCash from '../components/my/startCash/startCash.vue' //玩粉


import Vips from '../components/my/vips/vips.vue' //会员充值

import Login from '../components/user/login/login.vue' //用户登录
import LoginPwd from '../components/user/login/loginPwd.vue' //密码登录
import LoginMobile from '../components/user/login/loginMobile.vue' //手机号登录
import LoginVerificationCode from '../components/user/login/loginVerificationCode.vue' //短信验证码
import Agreement from '../components/user/agreement.vue' //用户协议
import Enroll from '../components/user/enroll/enroll.vue'  //手机号注册
import EnrollInviteCode from '../components/user/enroll/enrollInviteCode.vue'  //注册邀请码
import EnrollVerificationCode from '../components/user/enroll/enrollVerificationCode.vue'  //注册邀请码
import EnrollUsername from '../components/user/enroll/enrollUsername.vue' //用户名注册
import FillCode from '../components/user/enroll/fillCode.vue' //填写邀请码
...
import BindAlipay from '../components/user/accounts/bindAlipay.vue' //绑定支付宝
import ModifyAlipay from '../components/user/accounts/modifyAlipay.vue' //修改支付宝
import BindWechat from '../components/user/accounts/bindWechat.vue' //绑定微信
...
const $router = new Router({
  ...
  routes: [
    ...
    {
      path: '/recharge_calculator',
      name: 'rechargeCalculator',
      component: RechargeCalculator,
      meta:{
        title: '佣金计算器',
        index: 201,
        requireAuth: true,
    ...
    {
      path: '/official_announce',
      name: 'officialAnnounce',
      component: OfficialAnnounce,
      meta:{
        title: '官方公告',
        index: 203,
        requireAuth: true,
    ...
    {
      path: '/login_verification_code/:mobile',
    ...
    {
      path: '/enroll_invite_code',
      name: 'enrollInviteCode',
      component: EnrollInviteCode,
      meta:{
        title: '注册邀请码',
        index: 202
      }
    ...
    {
      path: '/enroll_verification_code/:invitationCode/:mobile',
      name: 'enrollVerificationCode',
      component: EnrollVerificationCode,
      meta:{
        title: '注册验证码',
        index: 204
      }
