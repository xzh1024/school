    ...
    <div class="main" @scroll.passive="onScroll($event)">
      ...
      <div class="head" ref="head">
        ...
        <div class="head_right">
          <!--<invitebind:class="isShareClass" @click=""></i>-->
      ...
      <div class="list">
        ...
        <div class="one" @click="$router.push({path:earningsUrl});">
          <div class="one_left"><i class="one_icon_collect"></i></div>
          <div class="one_center">我的收益</div>
          <div class="one_hint color_ababab"></div>
          <div class="one_right"><i class="icon_right_black"></i></div>
        </div>
...
//    components:{ MainTab },
    computed: { //计算属性
      ...
      earningsUrl: function () {  //我的收益
        return this.userInfo.id ? '/earnings' : '/login';
      },
