  ...
  <div class="beSold">
    <div class="top">
      ...
      <div class="top_list" v-show="iconType == 'icon_slide_up'">
        ...
        <div @click="setStatus(1)">支付成功</div>
        <div @click="setStatus(2)">等待打款</div>
    ...
    <div class="main"
      ...
      <div class="flex1">
        <mt-loadmore class="LoadMore" :auto-fill="false" :top-method="loadTop" ref="loadmore">
          <div class="TIPS small3 color_888888">*温馨提示:交易成功后所得收入扣去服务费后将会自动转入您的支付宝，我们也会给您发送短信，如果长时间未收到请及时联系客服进行沟通</div>
      ...
      getProduct() {
        if(this.status){
          ...
          var url = this.jointUrl({
            ...
            status: 4,  //状态 传0为全部 1 审核中 2 出售中 3 交易中 4已出售 5已下架
            page: this.page
          });
