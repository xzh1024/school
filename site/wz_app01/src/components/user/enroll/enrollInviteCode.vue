  ...
  <div class="enroll">
    ...
    <div class="enroll_main">
      <form action="" method="post">
        <ul class="login_form">
          <li class="input">
            <input class="input_center" type="text" placeholder="请输入邀请码或邀请手机号" v-model="invitationCode" v-on:keyup="codeChange" v-focus maxlength="11"/>
