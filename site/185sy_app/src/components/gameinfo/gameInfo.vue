    ...
    <!--<div id="tabTop"></div>-->
          ...
          <div class="gameBox" ref="gameBox">
            <div class="game" ref="game">
              ...
              <div class="game_c">
                ...
                <div class="">
                  <span class="icon_operate1" v-if="data.gameinfo.operate == 1"></span>
                  <span class="icon_operate2" v-else-if="data.gameinfo.operate == 2"></span>
                </div>
      ...
      <div class="footer">
        <div class="footer_l">
          ...
          <span class="color_blue small2">收藏</span>
        </div>
        <div class="footer_c">
          <a class="download_btn" v-if="$route.query.type == 3" @click="goGameH5(data.gameinfo.h5_url, data.gameinfo.appid, data.gameinfo.app_clientkey)">开始游戏</a>   <!--:href="data.gameinfo.h5_url"-->
          ...
          <!--<a class="download_btn" v-else-if="data.clipboard" :href="data.gameinfo.web_url" :download="data.gameinfo.web_pack" @click="downloadGame(event, data.gameinfo.tag);">立即下载</a>-->
        ...
        <div class="footer_r" @click="doComment">
          ...
          <span class="color_blue small2">评论</span>
        </div>
      </div>
      <mt-popup
        v-model="payFlag"
...
//      console.log(this.$store.dispatch)
      if(this.$route.params.operate == 1){
        this.topBoxBg = 'bg1';
      } else if(this.$route.params.operate == 2) {
        this.topBoxBg = 'bg2';
      }
		},
        ...
        this.$http.get("/www/api-game-gameInfo", {
          ...
          .then(response => {
            ...
            if(datas.status == 0) {//返回的状态，0为成功
              ...
              if(data.gameinfo.operate == 1){
                this.topBoxBg = 'bg1';
              } else if(data.gameinfo.operate == 2){
                this.topBoxBg = 'bg2';
              }
  ...
  .gameinfo{
    ...
    .gameinfo_main{
      ...
      .icon_game_comment{
        ...
        width: 1.7rem;
        height: 1.7rem;
        background: url("../../static/img/35_icon_pl.png") no-repeat;
        background-size: contain;
      }
		}
  }
