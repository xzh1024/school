<template>
  <div>
    ...
    <i-table
      ...
      :options="options"
      :api="cbdApiProjectReportDayOrderListGet"
    ></i-table>
  </div>
</template>
...
<script setup lang="ts">
  ...
  import {
    cbdApiProjectReportDayOrderChartGet,
    cbdApiProjectReportDayOrderListGet
  } from '@/api';
  ...
  const [getBarData] = useFuncProxy(async () => {
    const res = await cbdApiProjectReportDayOrderChartGet({ ...search.value });
