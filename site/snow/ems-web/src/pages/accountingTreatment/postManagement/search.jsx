...
import { getBusinessTypeList } from '@api/accountingTreatment/postManagement';
...
function Index() {
  ...
  const handleSearch = value => {
    ...
    postManagement.currentPage = 1;
    postManagement.searchParams = value;
    postManagement.getTableList(value);
  };

  const reset = () => {
    form.resetFields();
    postManagement.searchParams = {};
    postManagement.getTableList();
  };
    ...
    <div className="bg-white">
      ...
      >
        <Row gutter={20}>
          ...
          <Col span={6}>
            <Form.Item label="业务循环" name="businessTypeCode">
              <Select
                options={options}
                fieldNames={{
                  label: 'dictName',
