    ...
    <ProCard className="my-4" bodyStyle={{ padding: '0' }}>
      <MoreSearch toggle={setShowMore}>
        <Form form={form} {...layout} onFinish={handleSearch}>
          <Row gutter={20}>
            <Col span={6} order={1}>
              <Form.Item label="小组" className="form-item-label-warp mb-3" name="groupId">
                <Select
                  placeholder="请选择小组"
            ...
            <Col span={6} order={2}>
              <Form.Item label="申请人" className="form-item-label-warp mb-3" name="applyEmpName">
                <Input allowClear />
              </Form.Item>
            </Col>
            <Col span={6} order={3}>
            ...
            <>
              ...
              <Col span={6} order={5 + !showMore}>
                <Form.Item label="到池日期自" className="form-item-label-warp mb-3" name="processStateStartTimeMin">
                  <DatePicker format={'YYYY-MM-DD'} style={{ width: '100%' }} />
                </Form.Item>
              </Col>
              <Col span={6} order={6 + !showMore}>
                <Form.Item label="到池日期至" className="form-item-label-warp mb-3" name="processStateStartTimeMax">
                  <DatePicker format={'YYYY-MM-DD'} style={{ width: '100%' }} />
                </Form.Item>
              </Col>
