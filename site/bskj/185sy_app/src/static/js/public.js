export default {
  install(Vue,options)
  {
    ...
    Vue.prototype.myType = {
      ...
      domainName:'http://www.sy218.com/web',
      domainNameApi:'http://api.185sy.com',
      //渠道ID
      channel:185,
      //key
      ...
      sy185_user_token: 'nnsIx5GUdTHU#tOI',
      sy185_tra_user_token: 'MIYA&v$Xo*G9T96f',
