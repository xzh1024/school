...
export const transferStockinReturnService = new TransferService(TYPE);

export const TRANSFER_STOCKIN_RETURN_ENUM = [
  {
    label: "单据号",
    value: "billNo"
  },
...
export const TRANSFER_STOCKIN_RETURN_DETAIL_TOTAL_FILES = [
  { file: "qty", type: "qty" },
...
export const TRANSFER_STOCKIN_RETURN_DETAIL: TableSettingConfig<TransferBillPartItem> = {
  name: "globalTransferStockinReturnDetail",
  columns: [
    {
      prop: "index",
      label: "序号",
