...
import {
  TRANSFER_APPLY_ENUM,
  TRANSFER_APPLY_DETAIL_TOTAL_FILES,
  TRANSFER_APPLY_DETAIL,
  transferApplyService,
  DeaultHeader,
  defualtHeader
} from "./constants";
...
export default class TransferApply extends Mixins(Summaries) {
        ...
        <div class="flex-container">
          ...
          <div class="flex-block-margin flex-block-bg flex-block-padding auto-block flex-container column-flex">
            ...
            <ht-setting-table
              ...
              table-name={TRANSFER_APPLY_DETAIL.name}
              columns={TRANSFER_APPLY_DETAIL.columns}
              data={this.tableData}
