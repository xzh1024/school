...
import {
  TRANSFER_STOCKIN_RETURN_ENUM,
  TRANSFER_STOCKIN_RETURN_DETAIL_TOTAL_FILES,
  TRANSFER_STOCKIN_RETURN_DETAIL,
  transferStockinReturnService,
  DeaultHeader,
  defualtHeader
} from "./constants";
...
export default class TransferStockinReturn extends Mixins(Summaries) {
  ...
  private loadData() {
    this.loading = true;
    return transferStockinReturnService
        ...
        <div class="flex-container">
          <div class="ht-detail-form flex-block-margin flex-block-bg flex-block-padding">
            ...
            <bill-panel
              ...
              billEnum={TRANSFER_STOCKIN_RETURN_ENUM}
            />
          </div>
          ...
          <div class="flex-block-margin flex-block-bg flex-block-padding auto-block flex-container column-flex">
            ...
            <ht-setting-table
              ...
              table-name={TRANSFER_STOCKIN_RETURN_DETAIL.name}
              columns={TRANSFER_STOCKIN_RETURN_DETAIL.columns}
              data={this.tableData}
