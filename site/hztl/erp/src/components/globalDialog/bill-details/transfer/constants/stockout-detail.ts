...
export const transferStockoutService = new TransferService(TYPE);

export const TRANSFER_STOCKOUT_ENUM = [
  {
    label: "单据号",
    value: "billNo"
  },
...
export const TRANSFER_STOCKOUT_DETAIL_TOTAL_FILES = [
  { file: "qty", type: "qty" },
...
export const TRANSFER_STOCKOUT_DETAIL: TableSettingConfig<TransferBillPartItem> = {
  name: "globalTransferStockoutDetail",
  columns: [
    {
      prop: "index",
      label: "序号",
