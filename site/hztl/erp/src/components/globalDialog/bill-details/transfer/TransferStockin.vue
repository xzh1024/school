...
import {
  TRANSFER_STOCKIN_ENUM,
  TRANSFER_STOCKIN_DETAIL_TOTAL_FILES,
  TRANSFER_STOCKIN_DETAIL,
  transferStockinService,
  DeaultHeader,
  defualtHeader
} from "./constants";
...
export default class TransferStockin extends Mixins(Summaries) {
        ...
        <div class="flex-container">
          <div class="ht-detail-form flex-block-margin flex-block-bg flex-block-padding">
            ...
            <bill-panel
              ...
              billEnum={TRANSFER_STOCKIN_ENUM}
            />
          </div>
          ...
          <div class="flex-block-margin flex-block-bg flex-block-padding auto-block flex-container column-flex">
            ...
            <ht-setting-table
              ...
              table-name={TRANSFER_STOCKIN_DETAIL.name}
              columns={TRANSFER_STOCKIN_DETAIL.columns}
              data={this.tableData}
