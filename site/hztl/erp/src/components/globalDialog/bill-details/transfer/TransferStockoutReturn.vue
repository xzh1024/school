...
import {
  TRANSFER_STOCKOUT_RETURN_ENUM,
  TRANSFER_STOCKOUT_RETURN_DETAIL_TOTAL_FILES,
  TRANSFER_STOCKOUT_RETURN_DETAIL,
  transferStockoutReturnService,
  DeaultHeader,
  defualtHeader
} from "./constants";
...
export default class TransferStockoutReturn extends Mixins(Summaries) {
  ...
  private loadData() {
    this.loading = true;
    return transferStockoutReturnService
        ...
        <div class="flex-container">
          <div class="ht-detail-form flex-block-margin flex-block-bg flex-block-padding">
            ...
            <bill-panel
              ...
              billEnum={TRANSFER_STOCKOUT_RETURN_ENUM}
            />
          </div>
          ...
          <div class="flex-block-margin flex-block-bg flex-block-padding auto-block flex-container column-flex">
            ...
            <ht-setting-table
              ...
              table-name={TRANSFER_STOCKOUT_RETURN_DETAIL.name}
              columns={TRANSFER_STOCKOUT_RETURN_DETAIL.columns}
              data={this.tableData}
