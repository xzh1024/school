...
export default {
  name: "ImportPurchaseBillHistBox",
    ...
    return (
      ...
      >
        ...
        >
          ...
          <el-form-item label-width="215px" label="自动创建不存在的供应商">
        ...
        <div slot="remark" class="remark-container">
          数据要求：
          <br />
          1、导入数据必须包含：分公司名称、采购单号、供应商、支付方式、发票类型、业务日期、配件编码、配件名称、进货数量、进货价（含税）、到货仓库。
          <br />
          <br />
          数据说明：
          <br />
          ...
          <br />
          4、导入时如果没有货位（区架层位）信息，会默认导入到默认货位上。
          <br />
          5、若未指定配件性质，默认导入性质为完好。
          <br />
          6、仅支持导入已完成单据。
          <br />
          7、在导入时每一行数据都将按照配件编码、品牌和产地这3个字段与系统所存储的配件数据进行匹配，3个字段完全一致才会匹配成功。如果您的配件资料中有使用品牌和产地这两个字段，请在导入时也要加上这两个字段的数据。
          <br />
          <br />
          导入设置说明：
          <br />
          ...
          <br />
          3、若开启“自动创建不存在的供应商”则会匹配本地供应商，若无此供应商则自动新增。
          <br />
          <br />
          文件要求：
          <br />
