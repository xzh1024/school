    ...
    return (
      ...
      >
        ...
        <div slot="remark" class="remark-container">
          数据要求：
          <br />
          1、导入数据必须包含：分公司名称、采购退货单号、供应商、支付方式、发票类型、业务日期、配件编码、配件名称、退货数量、退货价（含税）、仓库。
          <br />
          <br />
          数据说明：
          <br />
          ...
          <br />
          2、导入前必须先导入采购单，否则匹配不到原采购单号会认为是无采购历史退货。
          <br />
          3、仅支持导入已完成单据。
          <br />
          <br />
