...
import { loadQuotationPurchasesHistory } from "@/api/basketHistory";
...
export default {
  ...
  props: {
    ...
    keyScope: {
      type: [Symbol, String],
      default: Symbol("partHistoryQuotationPurchase")
    }
  },
  data() {
    return {
      ...
      tableData: [],
      selectedRows: [],
      tableName: "partHistoryQuotationPurchase",
      tableColumns: [
        {
          prop: "index",
          label: "序号",
