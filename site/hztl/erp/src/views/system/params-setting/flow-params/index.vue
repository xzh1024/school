...
import ParamsFlow from "./params-flow";
...
export default {
  ...
  methods: {
    loadParams() {
      this.loading = true;
      getSystemParamsDetail({ module: "flow", type: this.paramsType })
        .then(res => {
    ...
    return (
      <el-row gutter={5} class="row-container">
        ...
        <el-col span={9} style="height: 100%;">
          <ht-card title="参数流程" style="margin: 5px 0; height: 100%;">
            <ParamsFlow paramsType={this.paramsType} />
          </ht-card>
        </el-col>
        <el-col span={10} v-loading={this.loading} style="height: 100%;">
          <ht-card
            title="参数设置"
