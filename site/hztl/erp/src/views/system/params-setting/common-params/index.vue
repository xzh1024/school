...
const defaultParams = {
  billNoRule: 0,
  businessManChangeable: true,
  defaultBusinessMan: 1,
  queryDefaultMonths: 3,
  queryDefaultDaysForBill: 30,
  modifiableAfterPrint: true,
  autoSubmitWhenClose: false,
  billPrintFlow: 0
};
...
export default {
  ...
  methods: {
    loadParams() {
      this.loading = true;
      getSystemParamsDetail({ module: "common", type: this.paramsType })
        .then(res => {
