...
const defaultParams = {
  noUpProperties: [],
  noUpWarehouses: [],
  noUpPriceTypesOfZero: [],
  customerDefaultPriceType: "",
  allocatingPriceRaiseRatio: null
};
...
export default {
  ...
  computed: {
    canSave() {
      // return this.hasAutoPerm("paramsSettings");
      return true;
    }
  },
  watch: {
    ...
    return (
      <el-row class="row-container">
        <el-col span={12} style="height: 100%;">
          ...
          >
            <span slot="after-title" style="color: #FFA708;">
        ...
        >
          <ht-card
            title="参数设置"
            style="margin: 5px 5px 5px 5px; height: 100%;"
          >
            <div
              slot="after-title"
