    ...
    >
      ...
      <el-form-item label="集采配件">
        <ht-autoselect
          ...
          v-model="formData.groupPurchase"
      ...
      <el-form-item label="供应商">
        <ht-autoselect
          v-if="setFoucs('supplierId')"
          v-delay-focus="setFoucs('supplierId')"
      ...
      switch (this.activeTab) {
        case TABS[0].id:
          parts = {
            ...
            groupPurchase: formData.groupPurchase,
