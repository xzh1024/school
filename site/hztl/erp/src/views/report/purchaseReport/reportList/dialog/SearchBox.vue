    ...
    >
      ...
      <el-form-item class="no-margin">
        ...
        <ht-select
          style="width:280px;"
          v-if="peopleType == 0"
          v-model="searchForm.businessManIds"
...
import { BILL_TYPE, INDEX_PATTERN, STATUS } from "../../../group";
import { DEFAULT_INDEX, PEOPLE_TYPE } from "../../group";
