...
<script>
import { financialLogOut } from "@/api/dailyManageReport";
import financicalDetailMixin from "../mixins/financialDetailMixin";
import { TABLE_COLUMN_FINANICIALLOGOUT_DETAIL } from "@/constants/report/financialLogOut";
...
export default {
  ...
  computed: {
    detailColumns() {
      return TABLE_COLUMN_FINANICIALLOGOUT_DETAIL.columns;
    }
  },
  methods: {
    // 获取账户下的分页信息
