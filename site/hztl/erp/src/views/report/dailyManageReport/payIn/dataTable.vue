...
<script>
import { payIn } from "@/api/dailyManageReport";
import businessDetailMixin from "../mixins/businessDetailMixin";
import { TABLE_COLUMN_PAY_IN_DETAIL } from "@/constants/report/payIn";
...
export default {
  ...
  computed: {
    detailColumns() {
      return TABLE_COLUMN_PAY_IN_DETAIL(this.query.dateType, this.query.code);
    }
  },
  methods: {
    // 获取账户下的分页信息
