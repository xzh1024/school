    ...
    <div class="flex-container column-flex" style="padding:5px;height: 100%">
      ...
      >
        <el-form ref="searchForm" :model="searchForm" inline>
          <el-form-item label="下次保养日期" size="mini" label-width="90px">
            <el-date-picker
              v-model="otherRange"
              type="daterange"
              range-separator="至"
        ...
        <el-card no-background no-padding style="height: 100%">
          <div>
            <el-button
              ...
              v-if="
                hasBelongsPermWithoutRoute('update', 'repairs.remind.maintain')
              "
            >
              微信提醒
            </el-button>
            ...
            <el-button
              ...
              v-if="
                hasBelongsPermWithoutRoute('export', 'repairs.remind.maintain')
              "
            >
              导出（Alt+D）
            </el-button>
...
import { MAINTENANCE_COLUMNS, STATUS_OPTIONS } from "../const/columns";
import {
  remindsList,
  remindsUpdate,
  exportReminds
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      selectedRows: [],
      tableColumns: MAINTENANCE_COLUMNS,
      totalSize: 0,
      currentPage: 1,
      exportVisible: false
    };
