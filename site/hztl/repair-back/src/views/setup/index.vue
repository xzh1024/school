<template>
  <layout-main>
    <div class="setup-component ht-container">
      <div class="ht-header">
...
import { SKU_TYPES, PRICE_TYPES } from "@/common/constants/options";
import {
  SetupFormParams,
  SkuSettingModel
...
export default class Setup extends Vue {
  ...
  protected skuOptions = SKU_TYPES;
  protected priceOptions = PRICE_TYPES;
