<template>
  <div class="quotation">
    ...
    <div v-if="dataObj.id">
          ...
          <div class="item_container">  
            ...
            <div class="item_w2 item_c_flex">
              <div class="item_c_flex margin_r" >
                <i class="iconfont icon-radio_sel sel_color" v-if="dataObj.id&&dataObj.flags.wash"></i>
                <i class="iconfont icon-radio_sel nor_color" v-else></i>
                <span class="item_content">洗车</span>
              </div>
              <div class="item_c_flex">
                <i class="iconfont icon-radio_sel sel_color" v-if="dataObj.id&&dataObj.flags.recovery"></i>
                <i class="iconfont icon-radio_sel nor_color" v-else></i>
      ...
      <div class="page_foot" >
        <div class="page_foot_flex">
          ...
          <van-button v-if="!dataObj.signed"
            class="foot_r button"
            @click="sureQuotation">报价确认</van-button>
        </div>
      </div>
    </div>
    ...
    <!-- 签字确认 -->
    <SignaturePopup v-if="!dataObj.signed" @setSign="setSign" ref="sign"/>
  </div>
</template>
