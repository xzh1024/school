<template>
  <div class="goods_search ">
    <!-- 查询组件 -->
    <span>关键字：</span>
    <el-input style="width:55%;margin-right:10px;"
     ...
     <el-button type="primary" size="small" plain @click="moreSeacrhFn">更多筛选 <i :class="moreSeacrhClass"></i></el-button>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    moreSeacrhFn(){
      ...
      this.moreSeacrhClass = this.moreSeacrh ? 'el-icon-arrow-up' : 'el-icon-arrow-down'; 
