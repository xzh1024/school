<template>
  <el-dialog
    custom-class="project-edit-dialog"
    title="批量设置-服务项目"
    ...
    <div>
      ...
      <div class="edit-item">
        <div class="checkbox-wrap">
          ...
          <el-select v-model="formData.priceType" size="small">
            <el-option
...
import { batchUpdateGoods, getVehicleLevelList } from '@/api/goods';
