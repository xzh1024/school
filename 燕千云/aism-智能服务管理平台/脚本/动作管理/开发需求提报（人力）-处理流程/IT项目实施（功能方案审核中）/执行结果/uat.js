/*
 * 
 * @Description:  功能方案设计中 状态ID(827937187706871808）
 * 
 */
...
$Print('处理人-t_approval_history', t_approval_history)
$Print('处理人-assigneePersonId', assigneePersonId)
if (assigneePersonId) {
    ...
    $Print('处理人-personName', person['real_name'])
    return {
        id: assigneePersonId,
