...
if (scItem) {
    ...
    $Print('可选值范围-extArrys:', extArrys);
    $Print('可选值范围-extArrys.length:', extArrys.length);
    ...
    $Print('可选值范围-extArrys2:', extArrys);
    $Print('可选值范围-extArrys2.length:', extArrys.length);
    if (extArrys.length > 0) {
    ...
    $Print('可选值范围-extArrys3:', extArrys);
    $Print('可选值范围-extArrys3.length:', extArrys.length);
    if (extArrys.length > 0) {
        // 存在精确匹配行或存在配置项值时，舍弃配置为空的行
        var arrys = extArrys;
    } else {
    ...
    $Print('可选值范围-extArrys4:', extArrys);
    $Print('可选值范围-extArrys4.length:', extArrys.length);
    if (extArrys.length > 0) {
        // 存在精确匹配行或存在配置项值时，舍弃配置为空的行
        var arrys = extArrys;
    } else {
