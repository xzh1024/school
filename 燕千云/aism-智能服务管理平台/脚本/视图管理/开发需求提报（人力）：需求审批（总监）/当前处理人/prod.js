 ...
 * @LastEditTime: 2026-01-07 18:51:43
...
$Print('------debug66 incident bool', incident['t_approval_history'].indexOf('796728311145693184') > -1);

var t_approval_history = incident['t_approval_history'];
// "637375316872663040:null:1,796728311145693184:653896785398902784:1,796727067706785792:641413566002171904:1"
if (t_approval_history) {
    if (t_approval_history.indexOf('796728311145693184') > -1) {
        var history_list = t_approval_history.split(',');
        if (history_list.length) {
            for (var i = 0;i < history_list.length;i++) {

                if (String(history_list[i]).indexOf("796728311145693184") > -1) {
