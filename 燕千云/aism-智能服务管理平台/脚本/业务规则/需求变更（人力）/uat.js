 ...
 * @LastEditTime: 2026-02-05 13:10:14
 * @FilePath: /script_backups_code/AISM/开发需求提报（人力）/需求变更确定按钮脚本.js
 * @Description: 
 */
...
var fieldsArr = [
    ...
    /*   "t_option_value_2", */
    "t_hr_system",
    /* 需求部门t_department 生产换字段：t_need_department */
    't_need_department',
    "t_system",
    "t_hr_function",
    /* date_daplgvoi 生产：t_date_daplgvoi
  date_aanmcgbb 生产：t_date_aanmcgbb
  date_owobqwpp 生产：t_date_owobqwpp
  date_fmcuaibf 生产：t_date_fmcuaibf */
    "t_date_daplgvoi",
    "t_date_aanmcgbb",
    "t_date_owobqwpp",
    "t_date_fmcuaibf",
    ...
    "t_attachment_name",
    /* master_detail_vfuafmtq 生产: t_master_detail_vfuafmtq */
    "t_master_detail_vfuafmtq",
    "t_acceptance_time",
    /* date_mvsumabe 生产：t_date_mvsumabe
    date_eibnmfby 生产：t_date_eibnmfby
    date_weqzersd 生产：t_date_weqzersd */
    "t_date_mvsumabe",
    "t_date_eibnmfby",
    "t_date_weqzersd",
    't_hr_type',
...
$Print("debug02 get t_hr_type_2====", curIncident['t_hr_type']);

/* 将工单类型标识回写到父单上 */
if (curIncident['t_hr_type'] !== '2') {
    $SetValue('t_hr_type', '3') /* 标识发生变更工单 */
}
...
$Print("debug02 incidentParticipants===", incidentParticipants);
...
function submitByCode (bo, params) {
    ...
    $Print("debug02 创建业务对象返回-id===", responseNode["id"]);
